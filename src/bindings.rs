...
fn bindgen_test_layout__xsltFormatNumberInfo() {
  ...
  assert_eq!(
    unsafe {
      &(*(::std::ptr::null::<_xsltFormatNumberInfo>())).is_negative_pattern as *const _ as usize
    },
    26usize,
    concat!(
      "Offset of field: ",
...
fn bindgen_test_layout__xsltTransformContext() {
  ...
  assert_eq!(
    unsafe {
      &(*(::std::ptr::null::<_xsltTransformContext>())).hasTemplKeyPatterns as *const _ as usize
    },
    392usize,
    concat!(
      "Offset of field: ",
  ...
  assert_eq!(
    unsafe {
      &(*(::std::ptr::null::<_xsltTransformContext>())).currentTemplateRule as *const _ as usize
    },
    400usize,
    concat!(
      "Offset of field: ",
  ...
  assert_eq!(
    unsafe {
      &(*(::std::ptr::null::<_xsltTransformContext>())).initialContextNode as *const _ as usize
    },
    408usize,
    concat!(
      "Offset of field: ",
...
extern "C" {
  pub fn xsltNumberFormat(ctxt: xsltTransformContextPtr, data: xsltNumberDataPtr, node: xmlNodePtr);
}
extern "C" {
...
extern "C" {
  pub fn xsltRegisterTmpRVT(ctxt: xsltTransformContextPtr, RVT: xmlDocPtr)
    -> ::std::os::raw::c_int;
}
extern "C" {
...
pub type xsltStyleExtInitFunction = ::std::option::Option<
  unsafe extern "C" fn(style: xsltStylesheetPtr, URI: *const xmlChar)
...
pub type xsltExtInitFunction = ::std::option::Option<
  unsafe extern "C" fn(ctxt: xsltTransformContextPtr, URI: *const xmlChar)
    -> *mut ::std::os::raw::c_void,
>;
...
extern "C" {
  pub fn xsltExtModuleFunctionLookup(name: *const xmlChar, URI: *const xmlChar)
    -> xmlXPathFunction;
}
extern "C" {
...
pub type xsltPreComputeFunction = ::std::option::Option<
  unsafe extern "C" fn(style: xsltStylesheetPtr, inst: xmlNodePtr, function: xsltTransformFunction)
    -> xsltElemPreCompPtr,
>;
extern "C" {
...
extern "C" {
  pub fn xsltCheckExtPrefix(style: xsltStylesheetPtr, URI: *const xmlChar)
    -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
  pub fn xsltElementAvailableFunction(ctxt: xmlXPathParserContextPtr, nargs: ::std::os::raw::c_int);
}
extern "C" {
...
extern "C" {
  pub fn xsltCleanupIds(ctxt: xsltTransformContextPtr, root: xmlNodePtr) -> ::std::os::raw::c_int;
}
extern "C" {
